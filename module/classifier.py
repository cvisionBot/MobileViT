...
class Classifier(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log('train_top1', self.top_1(y_pred, y), logger=True, on_step=True, on_epoch=True)
        self.log('train_top5', self.top_5(y_pred, y), logger=True, on_step=True, on_epoch=True)
        return loss
